...
export const UI = ({ drawEventHandler }) => {
  ...
  useEffect(() => {
    ...
    // console.log(newPlayerTile, "newPlayerTile UI");
  }, [newTileType]);
      ...
      <div className={styles.UIWrapper}>
        ...
        {turnPhase === 'Place Tile' && player.id === me.id ? (
          <div className={styles.buttonWrapper}>
            <TileControls drawEventHandler={drawEventHandler} newPlayerTile={newPlayerTile} setNewPlayerTile={setNewPlayerTile} />
          </div>
        ) : null}
      </div>
    </>
