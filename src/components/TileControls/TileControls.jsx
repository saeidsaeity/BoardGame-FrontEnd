...
function TileControls({ drawEventHandler, newPlayerTile, setNewPlayerTile }) {
  const {
    setTileRotation,
    newTileData,
    tileRotation,
  ...
  const confirmTileHandler = () => {
    ...
    // console.log(newPlayerTile, 'newPlayerTile');
    setNewPlayerTile(undefined)
    console.log(countRemainingTiles(gameTileCount), 'countRemainingTiles');
    removePlacedTile(newTileData.tile_type, gameTileCount);
  };
